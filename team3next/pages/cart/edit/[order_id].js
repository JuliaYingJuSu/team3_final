...
export default function OrderEdit() {
  ...
  const order_id = "4354";
  useEffect(() => {
    fetch(`http://localhost:3002/cart/order-d/${order_id}`, {
      method: "get",
      headers: {
        ...
        <div className="container w-100 border mt-4 d-flex justify-content-center ">
          <div className="row d-flex justify-content-start m-auto">
            ...
            <div className="ms-1 mt-3 row col-xxl-6">
              ...
              <div className="col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6 py-1 d-flex justify-content-between">
